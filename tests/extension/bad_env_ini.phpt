...
?>
--EXPECTF--
Notice: %s: [ddappsec] [Remote config] Enabled not configured, computing enabled status in Unknown on line 0

Notice: %s: [ddappsec] [Remote config] Enable status is 1 in Unknown on line 0
string(5) "trace"
